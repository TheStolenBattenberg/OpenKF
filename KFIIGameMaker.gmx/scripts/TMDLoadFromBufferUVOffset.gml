///TMDLoadFromBufferUVOffset(buffer, offset, offU, offV, page);
...
if(magicID != $00000041)
{
    show_debug_message("TMDLoadFromBuffer failed because of a bad magicID");
    return null;
}
    ...
    repeat(numPacket)
    {
        ...
        switch(packetID)
        {
            ...
            case $20000304:
                ...
                var N1 = buffer_read(tmdBuffer, buffer_u16);
                var V1 = buffer_read(tmdBuffer, buffer_u16);
                var V2 = buffer_read(tmdBuffer, buffer_u16);
                var V3 = buffer_read(tmdBuffer, buffer_u16);
            ...
            case $24000507:
                ...
                //Add data to Mesh Builder
                var T1 = MSMMeshBuilderAddTexcoord(msmMeshBuilder, TMDConvTCOffset(tcU1, tcV1, tsb, argument2, argument3, argument4));
                var T2 = MSMMeshBuilderAddTexcoord(msmMeshBuilder, TMDConvTCOffset(tcU2, tcV2, tsb, argument2, argument3, argument4));
                var T3 = MSMMeshBuilderAddTexcoord(msmMeshBuilder, TMDConvTCOffset(tcU3, tcV3, tsb, argument2, argument3, argument4));
            ...
            case $30000406:
                ...
                var N1 = buffer_read(tmdBuffer, buffer_u16);
                var V1 = buffer_read(tmdBuffer, buffer_u16);
                var N2 = buffer_read(tmdBuffer, buffer_u16);
                var V2 = buffer_read(tmdBuffer, buffer_u16);
                var N3 = buffer_read(tmdBuffer, buffer_u16);
                var V3 = buffer_read(tmdBuffer, buffer_u16);
            ...
            case $28000405:
                ...
                var V2 = buffer_read(tmdBuffer, buffer_u16);
                var V3 = buffer_read(tmdBuffer, buffer_u16);
                var V4 = buffer_read(tmdBuffer, buffer_u16);
                buffer_seek(tmdBuffer, buffer_seek_relative, 2);
            ...
            case $2C000709:
                ...
                var T2 = MSMMeshBuilderAddTexcoord(msmMeshBuilder, TMDConvTCOffset(tcU2, tcV2, tsb, argument2, argument3, argument4));
                var T3 = MSMMeshBuilderAddTexcoord(msmMeshBuilder, TMDConvTCOffset(tcU3, tcV3, tsb, argument2, argument3, argument4));
                var T4 = MSMMeshBuilderAddTexcoord(msmMeshBuilder, TMDConvTCOffset(tcU4, tcV4, tsb, argument2, argument3, argument4));   
                MSMMeshBuilderAddFace(msmMeshBuilder, MSMFace(V1,V2,V3, N1,N1,N1, T1,T2,T3, CC,CC,CC));
            ...
            case $38000508:
                ...
                var N3 = buffer_read(tmdBuffer, buffer_u16);
                var V3 = buffer_read(tmdBuffer, buffer_u16);
                var N4 = buffer_read(tmdBuffer, buffer_u16);
                var V4 = buffer_read(tmdBuffer, buffer_u16);
